...
#define CUSTOM_MACHINE_NAME "Alex3D VK"// Printer's unique ID, used by some programs to differentiate between machines.
...
#define EXTRUDE_MINTEMP 170  // 160 guards against false tripping when the extruder fan kicks on.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 2560, 93.0 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 300, 300, 6, 10000 }
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (5*60) }
...
#if EITHER(GRB_LED, RGBW_LED)
  //#define RGB_LED_R_PIN 34
  //#define RGB_LED_G_PIN 43
  //#define RGB_LED_B_PIN 35
  //#define RGB_LED_W_PIN -1
  //#define RGB_STARTUP_TEST              // For PWM pins, fade between all colors
  #if ENABLED(GRB_STARTUP_TEST)
    #define GRB_STARTUP_TEST_INNER_MS 10  // (ms) Reduce or increase fading speed
  #endif
#endif
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS          35 // Initial brightness (0-255)
 ...
 */
#if ANY(BLINKM, GRB_LED, RGBW_LED, PCA9632, PCA9533, NEOPIXEL_LED)
